...
public class ModelCliente {
    ...
    */
    ...
    /**
    * seta o valor de cliContato
    * @param pCliContato
    */
    public void setCliContato(String pCliContato){
        this.cliContato = pCliContato;
    }
    /**
    * @return cliContato
    */
    ...
    public String toString(){
        return "ModelCliente {" + "::idCliente = " + this.idCliente + "::cliNome = " + this.cliNome + "::cliEndereco = " + this.cliEndereco + "::cliBairro = " + this.cliBairro + "::cliCidade = " + this.cliCidade + "::cliUf = " + this.cliUf + "::cliCep = " + this.cliCep + "::cliContato = " + this.cliContato +  "}";
    }
}